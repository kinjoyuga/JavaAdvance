...
//出力結果ゾーン
        System.out.println("最初の人類" + namae.get(0));
        System.out.println("最後の人類" + namae.get(namae.size()-1));//exitが入力されてるから

        Collections.sort(namae,(s1,s2) -> {return s1.compareToIgnoreCase(s2);});
//sort機能を使いs1 s2にnamae代入後、
        System.out.println("並べ替えまする");
